    ...
    render() {
        return (
            <div className="Showcase__Content__root">
                <SortableList className="Showcase__style__list Showcase__style__stylizedList" items={this.state.items} onSortEnd={this.onSortEnd} axis='xy' useDragHandle={false} />
            </div>
        );
    }
}
